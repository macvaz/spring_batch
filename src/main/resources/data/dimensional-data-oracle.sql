-- Dimensional / reference data for Oracle (TEST environment seed).
-- No H2-specific sequence restart; rely on IDENTITY / sequence state after explicit IDs.
...
INSERT INTO "input_document" ("id", "document_id", "procedure_id", "citizen_id", "submission_channel", "source_file", "status", "received_at", "processed_at", "error_message") VALUES
  (1, 1, 1, 'CIT-001', 'TEST', 'dimensional-data-oracle.sql', 'VALIDATED', TIMESTAMP '2026-01-01 00:00:00', NULL, NULL),
  (2, 2, 1, 'CIT-002', 'TEST', 'dimensional-data-oracle.sql', 'VALIDATED', TIMESTAMP '2026-01-01 00:00:00', NULL, NULL);
